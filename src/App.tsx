...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start bg-gradient-to-br from-purple-start to-purple-end text-gray-900 font-sans p-6">
      ...
      <div className="w-full flex items-center justify-center absolute bottom-0 bg-red-700">
        <motion.div
          className="w-full cursor-pointer"
          drag="x"
          dragConstraints={{ left: 0, right: 0 }}
          onDragEnd={handleDragEnd}
          whileDrag={{ rotate: selectedIndex % 2 === 0 ? -40 : 40 }} // Apply rotation based on index direction
          animate={{ rotate: 0 }} // Smooth reset to center
